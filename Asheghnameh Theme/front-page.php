...
<!--/.Carousel Wrapper-->
        ...
        <div class="container">
			...
			<section id="about" class="text-center p-1">
				...
				<h1 class="h1-responsive font-weight-bold my-3">عاشقنامه | طالع بینی و فال عاشقانه</h1>
				<h3 class="lead w-responsive mx-auto mb-3">
				...
				<a href="http://uzee.ir/asheghnamehsite" class="btn btn-download btn-mobile white-text font-weight-bold wow fadeIn waves-effect waves-light mb-3" data-wow-delay="0.3s" onclick="return gtag_report_conversion('http://uzee.ir/asheghnamehsite');" style="visibility: visible; animation-name: fadeIn; animation-delay: 0.3s;">دانلود مستقیم عاشقنامه</a>
...
پیش‌بینی تصویر کودک از عکس شما و یارتان
      ...
      <div class="streak streak-photo streak-long-2 rgba-gradient" style="background-image: url('<?php echo get_template_directory_uri();?>/img/bg-footer.jpg');">
            <div class="flex-center mask pattern-1">
				...
				<div class="container-fluid bg-review-fal">
    ...
    <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
        <div class="main main-home mt-5">
            ...
            <div class="row">
                ...
                <!-- /.col-lg-3 col-md-6 -->
                <div class="col-lg-3 col-md-6 col-6 mb-4">
                    <a href="https://asheghnameh.com/%d8%b9%da%a9%d8%b3-%d8%b9%d8%a7%d8%b4%d9%82%d8%a7%d9%86%d9%87/" title="عکس عاشقانه">
                        <div class="card tools-card text-center">
                            <div class="tool-card-holder ani">
                                <div class="tool-card-over ">
                                </div>
