<?php /* Template Name: Car Price Peugeot */ ?>
...
$results = $wpdb->get_results( "SELECT * FROM $table_name WHERE brand =  'پژو' "); // Query to fetch data from database table and storing in $results
?>
