<?php /* Template Name: Car Price Parskhodro */ ?>
...
$results = $wpdb->get_results( "SELECT * FROM $table_name WHERE brand = 'پارس خودرو' "); // Query to fetch data from database table and storing in $results
?>
