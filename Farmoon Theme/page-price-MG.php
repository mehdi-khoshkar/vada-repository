<?php /* Template Name: Car Price  MG */ ?>
...
$results = $wpdb->get_results( "SELECT * FROM $table_name WHERE brand = 'ام جی' "); // Query to fetch data from database table and storing in $results
?>
