...
<div class="panel panel-primary box-rahvar">
	<div class="panel-heading">استعلام خلافی موتورسیکلت</div>
			...
			<div class="setup-content" id="step-1">
				<div class="col-xs-12">
					<div class="col-md-12">
						...
						<img class="img-help" src="https://farmooon.com/wp-content/uploads/2019/10/motor-new-compressor.jpg" alt="">
						</div>
						<div class="form-group">
							<input name="aform" value="add" type="hidden">
							<input name="rc" value="" type="hidden">
							<input type="hidden" name="duration" id="duration" value="">
							<label for="hashtraghami" class="text-rahvar">کد هشت یا نه رقمی کارت خود را بدون M وارد کنید</label>
							<div class="input-group">
							<a data-toggle="collapse" id="btn_help" data-target="#help"><i class="far fa-question-circle"></i></a>
                                <input class="form-control" type="text" name="hashtraghami" id="hashtraghami" placeholder="کد 8 رقمی کارت موتورسیکلت" required>			
			...
			<div class="col-xs-12">
					...
					<div class="row group-btn">
					       <a id="btnPrint" class="btn btn-success col-md-2 col-3">چاپ</a>
							...
							<a  href="https://farmooon.com/rahvar120/Mpanel" target="_blank"  class="btn btn-success col-md-3 col-8">مشاهده سوابق خلافی</a>
...
<!-- Jquery JS-->
<script src="https://farmooon.com/rahvar120/js/Mkhalafi.js"></script>
...
<script src="https://farmooon.com/rahvar120/js/wp-Mglobal.js"></script>
