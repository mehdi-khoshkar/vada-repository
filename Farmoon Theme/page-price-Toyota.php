<?php /* Template Name: Car Price  Toyota */ ?>
...
$results = $wpdb->get_results( "SELECT * FROM $table_name WHERE brand = 'تویوتا' "); // Query to fetch data from database table and storing in $results
?>
