<?php /* Template Name: Car Price  BMW */ ?>
...
$results = $wpdb->get_results( "SELECT * FROM $table_name WHERE brand = 'بی ام و' "); // Query to fetch data from database table and storing in $results
?>
