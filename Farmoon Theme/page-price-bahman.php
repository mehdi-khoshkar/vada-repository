<?php /* Template Name: Car Price  Bahman */ ?>
...
$results = $wpdb->get_results( "SELECT * FROM $table_name WHERE brand = 'گروه بهمن' "); // Query to fetch data from database table and storing in $results
?>
