<?php /* Template Name: Car Price KermanMotor */ ?>
...
$results = $wpdb->get_results( "SELECT * FROM $table_name WHERE brand = 'کرمان موتور' "); // Query to fetch data from database table and storing in $results
?>
