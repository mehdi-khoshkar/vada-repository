<?php /* Template Name: Car Price Iran Khodro */ ?>
...
$results = $wpdb->get_results( "SELECT * FROM $table_name WHERE brand = 'ایران خودرو' "); // Query to fetch data from database table and storing in $results
?>
