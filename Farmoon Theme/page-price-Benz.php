<?php /* Template Name: Car Price  Benz */ ?>
...
$results = $wpdb->get_results( "SELECT * FROM $table_name WHERE brand = 'بنز' "); // Query to fetch data from database table and storing in $results
?>
>
