<?php /* Template Name: Car Price  Renault */ ?>
...
$results = $wpdb->get_results( "SELECT * FROM $table_name WHERE brand = 'رنو' "); // Query to fetch data from database table and storing in $results
?>
