<?php /* Template Name: Car Price Modiran Khodro */ ?>
...
$results = $wpdb->get_results( "SELECT * FROM $table_name WHERE brand = 'مدیران خودرو' "); // Query to fetch data from database table and storing in $results
?>
