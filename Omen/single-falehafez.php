...
<div class="card-body card-body-cascade text-center">
	  ...
	  <div class="next_post">
	   <button type="button" class="btn purple-gradient"> <?php next_post_link(); ?> </button>
			...
			<a class="btn purple-gradient white-text font-weight-bold wow fadeIn waves-effect waves-light animated" rel="noopener noreferrer" data-toggle="modal" data-target="#centralModalSuccess" style="visibility: visible; animation-name: fadeIn;">برای گرفتن فال نیت کنید و اشاره ای بفرمایید</a>	
